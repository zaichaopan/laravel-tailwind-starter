            ...
            <div class="left flex justify-between w-full lg:w-auto flex-1 lg:flex-initial">
                <ul class="list-reset flex items-center">
                    <li class="">
                        <a
                            href="/home"
                            class="flex items-center h-16 text-grey-darker no-underline"
                        >Laravel</a>
                    </li>
                </ul>
                <div class="flex items-center lg:hidden" @click="toggleMobileNav">
                    <span class="hamburger-menu" :class="{open: shouldShowMobileNav}"></span>
                </div>
            </div>
            <!-- right -->
            <div
                class="right bg-white w-full lg:flex pt-0 lg:w-auto"
                    ...
                    <li class="py-0">
                        <base-dropdown dropdown-class="w-full lg:w-48" alignment="r" :z-index="50">
                            <a
                                slot="link"
                                href="#"
                                class="flex items-center h-16 text-sm font-light capitalize text-sm text-grey-darker underline no-underline"
                            >
                                {{user.name}}
                                &nbsp;
                            ...
                            <div slot="dropdown" class="bg-white border border-b-0 overflow-hidden">
                                <a
                                    href="#"
                                    class="no-underline block px-4 py-4 border-b text-sm text-grey-darker hover:bg-grey-lightest whitespace-no-wrap"
                                >Action</a>
                                <a
                                    href="#"
